...
export class CertificatesComponent implements OnInit, OnDestroy {
  ...
  certificates: Certificate[] = [
    ...
    },
    {
      ...
      link: 'https://www.freecodecamp.org/certification/michaelarnoldronquillo/responsive-web-design',
      btnLabel: 'View Certificate',
      accentColor: '#8a8a8a',
      accentLight: '#8a8a8a',
      bgText: 'FREECODECAMP',
    },
    {
      ...
      link: 'https://www.freecodecamp.org/certification/michaelarnoldronquillo/javascript-algorithms-and-data-structures',
      btnLabel: 'View Certificate',
      accentColor: '#f7df1e',
      accentLight: '#fbef6f',
      bgText: 'JAVASCRIPT',
